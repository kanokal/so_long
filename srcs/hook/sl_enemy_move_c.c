...
void	sl_enemy_move_c(t_sl_data *data)
{
	...
	while (idx < data->enemies.count)
	{
		if (data->enemies.group[idx].mv_dir == VIEW_NORTH)
			sl_enemy_move_north_c(data, &data->enemies.group[idx]);
		else if (data->enemies.group[idx].mv_dir == VIEW_SOUTH)
			sl_enemy_move_south_c(data, &data->enemies.group[idx]);
		else if (data->enemies.group[idx].mv_dir == VIEW_WEST)
			sl_enemy_move_west_c(data, &data->enemies.group[idx]);
		else if (data->enemies.group[idx].mv_dir == VIEW_EAST)
			sl_enemy_move_east_c(data, &data->enemies.group[idx]);
		idx++;
	}
}
