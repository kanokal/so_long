...
/*   Updated: 2021/07/02 19:16:42 by jpyo             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	sl_enemy_move_north_w(t_sl_data *data, t_enemy_data *enemy)
{
	if (data->map.grid[enemy->pos_y - 1][enemy->pos_x] == '1')
	{
		...
		return (sl_enemy_move_east_w(data, enemy));
	}
...
static void	sl_enemy_move_south_w(t_sl_data *data, t_enemy_data *enemy)
{
	if (data->map.grid[enemy->pos_y + 1][enemy->pos_x] == '1')
	{
		...
		return (sl_enemy_move_west_w(data, enemy));
	}
	else if (data->map.grid[enemy->pos_y + 1][enemy->pos_x] == 'P' || data->map.grid[enemy->pos_y + 1][enemy->pos_x] == 'p')
		exit(0);
	else if (data->map.grid[enemy->pos_y + 1][enemy->pos_x] == 'E')
...
static void	sl_enemy_move_west_w(t_sl_data *data, t_enemy_data *enemy)
{
	if (data->map.grid[enemy->pos_y][enemy->pos_x - 1] == '1')
	{
		...
		return (sl_enemy_move_north_w(data, enemy));
	}
...
static void	sl_enemy_move_east_w(t_sl_data *data, t_enemy_data *enemy)
{
	if (data->map.grid[enemy->pos_y][enemy->pos_x + 1] == '1')
	{
		...
		return (sl_enemy_move_south_w(data, enemy));
	}
	else if (data->map.grid[enemy->pos_y][enemy->pos_x + 1] == 'P' || data->map.grid[enemy->pos_y][enemy->pos_x + 1] == 'p')
		exit(0);
...
void	sl_enemy_move_w(t_sl_data *data)
{
	...
	{
		if (data->enemies.group[idx].mv_dir == VIEW_NORTH)
			sl_enemy_move_north_w(data, &data->enemies.group[idx]);
		else if (data->enemies.group[idx].mv_dir == VIEW_SOUTH)
			sl_enemy_move_south_w(data, &data->enemies.group[idx]);
		else if (data->enemies.group[idx].mv_dir == VIEW_WEST)
			sl_enemy_move_west_w(data, &data->enemies.group[idx]);
		else if (data->enemies.group[idx].mv_dir == VIEW_EAST)
			sl_enemy_move_east_w(data, &data->enemies.group[idx]);
		idx++;
	}
}
